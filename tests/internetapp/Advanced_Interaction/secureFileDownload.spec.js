...
const {SecureFileDownloadPage} = require('../../../pages/internet/secureFileDownloadPage.js');
const { ensureDirExists } = require('../../../utils/fileHelper.js');
const path = require('path');

test.describe('Secure File Download - The Internet', () => {
  test('should download a specific file from the download page', async ({ page, browserName }) => {
